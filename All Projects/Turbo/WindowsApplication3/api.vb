...
Namespace L0N3LY
    ...
    Friend Module api
        ...
        Public Function smethod_0(object_0 As Object, object_1 As Object) As Object
            ...
            text = String.Format("{0}.{1}", api.smethod_4(text, api.string_12), text)
            stringBuilder.AppendLine("--" + api.string_15)
            ...
            stringBuilder.Append("--" + api.string_15 + "--")
            Dim text2 As String = api.smethod_1(stringBuilder)
        ...
        Public Function smethod_1(stringBuilder_0 As StringBuilder) As String
            ...
            Try
                ...
                Dim httpWebRequest As HttpWebRequest = CType(WebRequest.Create(api.string_14 + "accounts/login/"), HttpWebRequest)
                httpWebRequest.AutomaticDecompression = DecompressionMethods.GZip
                httpWebRequest.Method = "POST"
                httpWebRequest.Host = api.string_8
                httpWebRequest.UserAgent = api.string_10
                httpWebRequest.Headers.Add("Accept-Language", "en;q=0.9")
                httpWebRequest.KeepAlive = True
                httpWebRequest.Proxy = Nothing
                httpWebRequest.ContentType = "multipart/form-data; boundary=" + api.string_15
                    ...
                    Try
                        Try
                            For Each obj As Object In httpWebResponse.Cookies
                                ...
                                api.string_13 = api.string_13 + objectValue3.ToString() + ";"
                            Next
                        Finally
        ...
        Public Function smethod_2(cookieContainer_1 As CookieContainer) As Object
            ...
            Try
                ...
                Dim httpWebRequest As HttpWebRequest = CType(WebRequest.Create(api.string_14 + "accounts/logout/"), HttpWebRequest)
                httpWebRequest.AutomaticDecompression = DecompressionMethods.GZip
                httpWebRequest.Method = "POST"
                httpWebRequest.Host = api.string_8
                httpWebRequest.UserAgent = api.string_10
        ...
        Public Function smethod_3() As Object
            ...
            httpWebRequest.KeepAlive = True
            httpWebRequest.UserAgent = api.string_9
            httpWebRequest.Proxy = Nothing
            httpWebRequest.CookieContainer = api.cookieContainer_0
            Try
                Dim httpWebResponse As HttpWebResponse = CType(httpWebRequest.GetResponse(), HttpWebResponse)
                Using streamReader As StreamReader = New StreamReader(httpWebResponse.GetResponseStream())
                    ...
                    api.string_0 = Regex.Match(input, "pk"": (.*?),").Groups(1).Value
                    api.string_5 = Regex.Match(input, "email"": ""(.*?)""").Groups(1).Value
                    api.string_3 = Regex.Match(input, "phone_number"": ""(.*?)""").Groups(1).Value
        ...
        Public string_31 As String = String.Empty
        ...
        Public string_9 As String = "Instagram 20.6.4 Android (18/4.3; 480dpi; 1080x1812; HUAWEI; HUAWEI VNS-L31; HWVNS-H; hi6250; es_ES)"

        ' Token: 0x04000016 RID: 22
        Public string_10 As String = "Instagram 20.6.4 Android (18/4.3; 480dpi; 1080x1812; HUAWEI; HUAWEI VNS-L31; HWVNS-H; hi6250; es_ES)"
